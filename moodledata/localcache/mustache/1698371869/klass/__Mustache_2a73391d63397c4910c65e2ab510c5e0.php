...
class __Mustache_2a73391d63397c4910c65e2ab510c5e0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_klass/slideshow')) {
            $buffer .= $partial->renderInternal($context, $indent . '    ');
        }
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="fp-site-customdesc">
';
        $buffer .= $indent . '        <div class="container">
';
        $buffer .= $indent . '            ';
        $value = $context->find('whotitle');
        $buffer .= $this->section5ee2746ee18c963dc65df54a57706555($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '            ';
        $value = $context->find('whodesc');
        $buffer .= $this->sectionB991dd54e59c23bc800fa1e9a4cf6144($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section5ee2746ee18c963dc65df54a57706555(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '<h2>{{{whotitle}}}</h2>';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '<h2>';
                $value = $this->resolveValue($context->find('whotitle'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '</h2>';
                $context->pop();
            }
    ...
    private function sectionB991dd54e59c23bc800fa1e9a4cf6144(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '<p>';
                $value = $this->resolveValue($context->find('whodesc'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '</p>';
                $context->pop();
            }
