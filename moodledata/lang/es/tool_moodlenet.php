...
/**
 * Strings for component 'tool_moodlenet', language 'es', version '4.1'.
 *
...
$string['autoenablenotification'] = '<p>A partir de Moodle 4.0, la integración de <a href="https://moodle.net/">MoodleNet</a> está habilitada de forma predeterminada en las funciones avanzadas. Los usuarios con la capacidad de crear y administrar actividades pueden explorar MoodleNet a través del selector de actividades e importar recursos de MoodleNet a sus cursos.</p><p>Si lo desea, se puede especificar una instancia alternativa de MoodleNet en <a href="{$ a->settingslink}">Configuración de MoodleNet</a>.</p>';
